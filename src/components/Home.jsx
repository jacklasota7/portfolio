function Home() {
  return (
    <section 
      id="home"
      className="min-h-screen flex items-center justify-center relative bg-black pt-32 sm:pt-20 md:pt-0"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-0 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
        {/* Left side - Text content */}
        <div className="flex-1 text-left max-w-2xl w-full mt-8 sm:mt-0">
